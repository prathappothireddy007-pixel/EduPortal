...
const runSchemaAndMigrations = async (client) => {
  try {
    ...
    const migrations = [
      ...
      `ALTER TABLE subjects ADD COLUMN IF NOT EXISTS exam_session VARCHAR(100) DEFAULT 'FN (09:30 AM - 12:30 PM)'`,
      `ALTER TABLE subjects ADD COLUMN IF NOT EXISTS exam_hall VARCHAR(255) DEFAULT 'Main Hall A'`,
      `ALTER TABLE subjects ALTER COLUMN exam_session TYPE VARCHAR(100)`,
      `ALTER TABLE subjects ALTER COLUMN exam_hall TYPE VARCHAR(255)`,
      ...
      `ALTER TABLE subjects ADD COLUMN IF NOT EXISTS slot VARCHAR(10) DEFAULT 'A'`,
      `ALTER TABLE od_requests ADD COLUMN IF NOT EXISTS slot VARCHAR(10) DEFAULT 'A'`,
      `ALTER TABLE od_requests ADD COLUMN IF NOT EXISTS lat DOUBLE PRECISION`,
      `ALTER TABLE od_requests ADD COLUMN IF NOT EXISTS lng DOUBLE PRECISION`,
      `ALTER TABLE od_requests ADD COLUMN IF NOT EXISTS location_name TEXT`,
      `ALTER TABLE od_requests ADD COLUMN IF NOT EXISTS radius_meters INTEGER DEFAULT 30`,
      ...
      `ALTER TABLE resources ADD COLUMN IF NOT EXISTS file_data TEXT`,
